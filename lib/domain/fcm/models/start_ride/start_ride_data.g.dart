...
part of 'start_ride_data.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

StartRideData _$StartRideDataFromJson(Map<String, dynamic> json) =>
    StartRideData(
      ...
      vehicle: json['vehicle'] == null
          ? null
          : StartRidevehicle.fromJson(json['vehicle'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$StartRideDataToJson(StartRideData instance) =>
    <String, dynamic>{
