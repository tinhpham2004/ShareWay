...
part of 'end_ride_data.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

EndRideData _$EndRideDataFromJson(Map<String, dynamic> json) => EndRideData(
      ...
      vehicle: json['vehicle'] == null
          ? null
          : EndRideVehicle.fromJson(json['vehicle'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$EndRideDataToJson(EndRideData instance) =>
    <String, dynamic>{
