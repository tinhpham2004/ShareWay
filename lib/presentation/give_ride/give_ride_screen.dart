...
import 'package:share_way_frontend/presentation/give_ride/bloc/give_ride_bloc.dart';
...
class _GiveRideScreenState extends State<GiveRideScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocBuilder<GiveRideBloc, GiveRideState>(
  ...
  Widget _buildFilterButton({
    ...
    return BlocBuilder<GiveRideBloc, GiveRideState>(
      builder: (context, state) {
        return AppButton(
          title: title,
      ...
      builder: (context, state) {
        return ListView.separated(
          ...
          separatorBuilder: (context, index) =>
              Divider(color: AppColor.secondary300),
          itemBuilder: (context, index) {
