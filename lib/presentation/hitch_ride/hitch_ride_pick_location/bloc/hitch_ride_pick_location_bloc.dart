...
class HitchRidePickLocationBloc extends Cubit<HitchRidePickLocationState> {
  HitchRidePickLocationBloc() : super(HitchRidePickLocationState());
  ...
  void onConfirm(BuildContext context) {
    ...
    GoRouter.of(context).push(AppPath.hitchRidePickTime, extra: data);
  }
