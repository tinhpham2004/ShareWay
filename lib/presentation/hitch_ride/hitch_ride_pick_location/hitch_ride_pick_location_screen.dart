...
import 'package:share_way_frontend/presentation/hitch_ride/hitch_ride_pick_location/bloc/hitch_ride_pick_location_bloc.dart';
import 'package:share_way_frontend/presentation/hitch_ride/hitch_ride_pick_location/bloc/hitch_ride_pick_location_state.dart';

class HitchRidePickLocationScreen extends StatefulWidget {
  HitchRidePickLocationScreen({super.key});

  @override
  State<HitchRidePickLocationScreen> createState() =>
      _HitchRidePickLocationScreenState();
}

class _HitchRidePickLocationScreenState
    extends State<HitchRidePickLocationScreen> {
  late HitchRidePickLocationBloc bloc;

  @override
  void initState() {
    bloc = HitchRidePickLocationBloc();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child:
          BlocListener<HitchRidePickLocationBloc, HitchRidePickLocationState>(
        ...
        child:
            BlocBuilder<HitchRidePickLocationBloc, HitchRidePickLocationState>(
  ...
  Widget _buildFilterButton({
    ...
    return BlocBuilder<HitchRidePickLocationBloc, HitchRidePickLocationState>(
      builder: (context, state) {
        return AppButton(
          title: title,
